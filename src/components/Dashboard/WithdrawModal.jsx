          ...
          {success ? (
            <div className="p-8 text-center">
              ...
              <p className="text-sm text-gray-400 mb-6 flex items-center justify-center gap-1">
                <Clock className="w-4 h-4" /> Typically 3–5 business days
              </p>
            ...
            <>
              ...
              <div className="flex items-center justify-between px-5 pt-5 pb-4 border-b border-gray-100">
                <div>
                  ...
                  <p className="text-sm text-gray-500 mt-0.5">Crypto payout · 3–5 business days</p>
                </div>
              ...
              <div className="px-5 py-4 space-y-4 max-h-[70vh] overflow-y-auto">
                ...
                {loading ? (
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    ...
                    <div className="bg-amber-50 border border-amber-200 rounded-xl p-3 text-center">
                      ...
                      <p className="text-xl font-bold text-amber-700">${balance.pending.toFixed(2)}</p>
                      <p className="text-[10px] text-amber-500">3–5 day hold</p>
                    </div>
                  </div>
                )}
                ...
                <div className="flex items-start gap-2 bg-blue-50 border border-blue-200 rounded-xl px-4 py-3">
                  ...
                  <p className="text-xs text-blue-700">
                    Withdrawals are processed within 1–2 business days. Minimum withdrawal is ${MIN_WITHDRAW}. Double-check your wallet address before submitting.
                  </p>
                </div>
